...
from main.functions.Manage_Databes import Manage_Database
import datetime
...
#	u=True
	boton = {'stock_name':'AAPL'}
	if request.user.is_authenticated:
		db = Manage_Database()
		start_time = datetime.datetime(2020, 9, 21).strftime('%Y-%m-%d')
		end_time=datetime.datetime(2020, 9, 23).strftime('%Y-%m-%d')
		tokers = db.input_gaphs(stock_name='AAPL',start_time=start_time,end_time=end_time)
#	if u:
		context={"caca":"shit","2":"lil madafuka","hhh":"iii"}
#		tokers={'primero': {'Time':'2020-09-16 00:00:00','High': 116.0, 'Close': 112.12999725341797, 'Volume': 154679000, 'Open': 115.2300033569336, 'Low': 112.04000091552734}, 'segundo': {'Time':'2020-09-14 00:00:00','High': 115.93000030517578, 'Close': 115.36000061035156, 'Volume': 140150100, 'Open': 114.72000122070312, 'Low': 112.80000305175781}, 'tercero': {'Time':'2020-09-17 00:00:00','High': 112.19999694824219, 'Close': 110.33999633789062, 'Volume': 178011000, 'Open': 109.72000122070312, 'Low': 108.70999908447266}, 'cuarto': {'Time':'2020-09-10 00:00:00','High': 120.5, 'Close': 113.48999786376953, 'Volume': 182274400, 'Open': 120.36000061035156, 'Low': 112.5}, 5: {'Time':'2020-09-15 00:00:00','High': 118.83000183105469, 'Close': 115.54000091552734, 'Volume': 184642000, 'Open': 118.33000183105469, 'Low': 113.61000061035156}, 6: {'Time':'2020-09-18 00:00:00','High': 110.87999725341797, 'Close': 106.83999633789062, 'Volume': 286693600, 'Open': 110.4000015258789, 'Low': 106.08999633789062}, 7: {'Time':'2020-09-11 00:00:00','High': 115.2300033569336, 'Close': 112.0, 'Volume': 180860300, 'Open': 114.56999969482422, 'Low': 110.0}}
#		posts = Post.objects.filter(published_date__lte=timezone.now()).order_by('published_date')
		return render(request, 'main.html', tokers)
	else:
